...
export const SEO_ROUTES = {
  ...
  "/gold-value": {
    title: "금 가치 계산기 | 14K·18K·순금 중량별 오늘 가치 | 한국골드마켓",
    description:
      "14K·18K·순금의 중량을 입력해 오늘 공개 시세 기준 참고가치와 예상 순금량을 계산하세요. 계산 후 MY GOLD에 기록해 가치 변화를 이어서 확인할 수 있습니다.",
    ogTitle: "14K·18K·순금 오늘 가치 계산 | 한국골드마켓",
    ogDescription:
      "금 종류와 중량을 입력해 오늘 참고가치와 예상 순금량을 바로 확인하세요.",
    imageAlt: "한국골드마켓 금 가치 계산기",
  },
  "/my-gold": {
