...
// 운영자(사업자) 정보
const OPERATOR = {
  brand: "한국골드마켓",                 // 서비스 브랜드
  company: "원일귀금속",                 // 운영자 상호(사업자등록증 상)
  rep: "나영호",
  regNo: "865-41-00244",                 // 사업자등록번호
  mailOrderNo: "미기재",                 // 통신판매업신고번호(있으면 교체)
  address: "부산광역시 부산진구 골드테마길 21(범천동)",
  phone: "010-7713-3739",               // ← 업데이트
  email: "lifeapproch@naver.com",       // ← 업데이트
};
  ...
  return (
    <>
      ...
      <Container>
        ...
        <Section>
          <h2>제11조 (개인정보보호)</h2>
          <p>개인정보 처리에 관한 사항은 별도의 <a href="/privacy"><strong>개인정보처리방침</strong></a>을 따릅니다.</p>
        </Section>

        <Section>
          <h2>제12조 (위치기반서비스)</h2>
          <p>위치 기능은 <a href="/lspa"><strong>위치기반서비스 이용약관</strong></a>에 동의한 경우 제공됩니다.</p>
        </Section>
