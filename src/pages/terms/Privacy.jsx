      ...
      <P_Container>
        ...
        <P_Section>
          ...
          <ul>
            ...
            <li>
              <strong>순금 혜택 중복 방지</strong>: 이메일 인증 완료 주소를
        ...
        <P_Section>
          ...
          <ul>
            ...
            <li>탈퇴 후 재가입을 포함한 순금 혜택의 중복 수령 방지</li>
            <li>
        ...
        <P_Section>
          ...
          <p>
            순금 혜택은 재산적 가치가 있는 1회성 혜택이므로, 탈퇴 후 재가입을
            통한 반복 수령을 방지하기 위해 필요한 최소 범위의 중복 방지 기록을
            서버 전용 영역에 별도 보관합니다. 이 기록에는 원문 이메일, 성명,
            휴대전화번호 또는 회원 UID를 저장하지 않고, 인증된 이메일을
            정규화한 뒤 SHA-256으로 일방향 해시 처리한 식별값과 혜택
            종류·수령 여부·기록 시각만 저장합니다. 보유기간은 회원 유지 기간
            및 회원 탈퇴 후 3년이며, 그 전에 혜택 제도가 종료되는 등 중복
            방지 목적이 소멸하면 지체 없이 삭제합니다.
          </p>
          ...
          <TableWrap>
            <Table>
              ...
              <tbody>
                ...
                <tr>
                  <td>순금 혜택 중복 방지 기록</td>
                  <td>
                    인증 이메일의 SHA-256 일방향 해시값, 혜택 종류·수령 여부·
                    기록 시각을 회원 유지 기간 및 탈퇴 후 3년간 보관.
                    중복 방지 목적이 먼저 소멸하면 지체 없이 삭제
                  </td>
                </tr>
                <tr>
                  <td>접속·보안 로그</td>
