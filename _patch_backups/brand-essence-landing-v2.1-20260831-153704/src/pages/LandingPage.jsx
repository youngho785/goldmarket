...
const DrawerSection = styled(Section)`
  ...
  &::after {
    content: "GOLD TO GOLD";
    position: absolute;
    right: -12px;
    bottom: -22px;
    color: color-mix(in srgb, ${({ theme }) => theme.colors.white} 5%, transparent);
    font-family: ${({ theme }) => theme.fonts.numeric};
  ...
  ${SectionLead} {
    ...
    z-index: 1;
    max-width: 760px;
    color: color-mix(in srgb, ${({ theme }) => theme.colors.white} 76%, transparent);
  }
...
const StoryItems = styled.div`
  ...
  border-top: 1px solid color-mix(in srgb, ${({ theme }) => theme.colors.white} 22%, transparent);
  border-left: 1px solid color-mix(in srgb, ${({ theme }) => theme.colors.white} 22%, transparent);
...
const StoryItem = styled.div`
  min-height: 112px;
  padding: 20px 18px;
  border-right: 1px solid color-mix(in srgb, ${({ theme }) => theme.colors.white} 22%, transparent);
  border-bottom: 1px solid color-mix(in srgb, ${({ theme }) => theme.colors.white} 22%, transparent);
...
const ValueStory = styled.div`
  ...
  border: 1px solid ${({ theme }) => theme.colors.secondary};
  background: color-mix(in srgb, ${({ theme }) => theme.colors.white} 5%, transparent);
...
const ValueStep = styled.div`
  padding: 18px 16px;
  border: 1px solid color-mix(in srgb, ${({ theme }) => theme.colors.white} 22%, transparent);
  background: color-mix(in srgb, ${({ theme }) => theme.colors.white} 4%, transparent);
